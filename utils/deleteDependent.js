...
let JobSchedule = require('../model/JobSchedule');
...
const deleteJobSchedule = async (filter) =>{
  try {
    let response  = await dbService.destroy(JobSchedule,filter);
    return response;
  } catch (error){
...
const deleteCustomers = async (filter) =>{
  try {
    let response  = await dbService.destroy(Customers,filter);
    return response;
  } catch (error){
    throw new Error(error.message);
  }
...
const deleteUser = async (filter) =>{
  try {
    ...
    if (user && user.length){
      ...
      const JobScheduleFilter = { $or: [{ addedBy : { $in : user } },{ updatedBy : { $in : user } }] };
      const JobScheduleCnt = await dbService.destroy(JobSchedule,JobScheduleFilter);

      const customersFilter = { $or: [{ addedBy : { $in : user } },{ updatedBy : { $in : user } }] };
      ...
      let response = {
        JobSchedule :JobScheduleCnt.length,
...
const countJobSchedule = async (filter) =>{
  try {
    const JobScheduleCnt =  await dbService.count(JobSchedule,filter);
    return { JobSchedule : JobScheduleCnt };
  } catch (error){
    throw new Error(error.message);
  }
};
...
const countCustomers = async (filter) =>{
  try {
    const customersCnt =  await dbService.count(Customers,filter);
    return { customers : customersCnt };
  } catch (error){
    throw new Error(error.message);
  }
};
...
const countUser = async (filter) =>{
  try {
    ...
    if (user && user.length){
      ...
      const JobScheduleFilter = { $or: [{ addedBy : { $in : user } },{ updatedBy : { $in : user } }] };
      const JobScheduleCnt =  await dbService.count(JobSchedule,JobScheduleFilter);
...
const softDeleteJobSchedule = async (filter,updateBody) =>{  
  try {
    const JobScheduleCnt =  await dbService.update(JobSchedule,filter);
    return { JobSchedule : JobScheduleCnt };
  } catch (error){
    throw new Error(error.message);
  }
...
const softDeleteCustomers = async (filter,updateBody) =>{  
  try {
    const customersCnt =  await dbService.update(Customers,filter);
    return { customers : customersCnt };
  } catch (error){
    throw new Error(error.message);
  }
...
const softDeleteUser = async (filter,updateBody) =>{  
  try {
    ...
    if (user.length){
      ...
      const JobScheduleFilter = { '$or': [{ addedBy : { '$in' : user } },{ updatedBy : { '$in' : user } }] };
      const JobScheduleCnt = await dbService.update(JobSchedule,JobScheduleFilter,updateBody);
